...
<nav class="navbar navbar-expand-lg w-100 p-0">
    ...
    <div class="show-on-mob my-2">
        <span class="nav-mob">
            <a href="" data-toggle="modal" data-target="#search"><i class="fas fa-search"></i></a>
        </span>
        <span class="nav-mob m-0">
            <a href="" data-toggle="modal" data-target="#langModal"><i class="fas fa-globe"></i></a>
        </span>
        <span class="nav-mob m-0">
            <a href="" class="showCart"><i class="fas fa-shopping-cart"></i></a>
        </span>
        <span class="nav-mob m-0">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item drop-item <?= $id == $cat->id && $action == 'view' && $controller == 'category' || $active_category == $cat->id ? 'active' : ''?>"
                id="<?= $cat->id?>">
                <a class="nav-link" style="padding: 3px 15px;"
                    href="<?= Url::to(['category/view', 'id' => $cat->id]);?>" role="button" id="luxuty-roses-item"
                    aria-haspopup="true" aria-expanded="false"><?= $cat->$name?></a>
            ...
            <li class="nav-item icon-item mx-0 px-3">
                <a href="" class="nav-link" data-toggle="modal" data-target="#langModal"><i
