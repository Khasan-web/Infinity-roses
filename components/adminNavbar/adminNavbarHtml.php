...
<li class="<?= $home?>"><a href="<?= Url::to(['/admin'])?>"><i class="fa fa-tachometer fa-fw">
    <div class="icon-bg bg-orange"></div>
</i><span class="menu-title">Dashboard</span></a></li>
<li class="<?= $products?>"><a href="#"><i class="fa fa-th-list fa-fw">
...
<li class="<?= $categories?>"><a href="#"><i class="fa fa-dropbox fa-fw">
...
<li class="<?= $orders?>"><a href="#"><i class="fa fa-users">
...
<li class="<?= $events?>"><a href="#"><i class="fa fa-calendar fa-fw">
    <div class="icon-bg bg-violet"></div>
