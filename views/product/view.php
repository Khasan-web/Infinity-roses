    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
                ...
                ?>
                <img src="<?= $mainImage->getUrl() ?>" alt="<?= $main_color_name ?>" data-position="<?= $main_image_position ?>" class="active-img" data-color="<?= $main_color_name ?>">
                <div class="row product__position" data-product-id="<?= $product->id ?>">
                    ...
                    <div class="col-3">
                        <img data-src="<?= $image->getUrl() ?>" src="<?= $image->getUrl('300x') ?>" data-size="<?= $size ?>" data-position="<?= $image_position ?>" alt="<?= $image_position ?>">
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="col-3">
                        <img data-src="<?= $image->getUrl() ?>" class="closed" src="<?= $image->getUrl('300x') ?>" data-size="<?= $size ?>" data-position="<?= $image_position ?>" alt="<?= $image_position ?>">
                    </div>
                    <?php endif; ?>
                    <?php endforeach; ?>
            ...
            <div class="col-lg-6 col-md-12 info">
                ...
                <div class="row colors">
                    ...
                    <div class="col-3 color">
                        <img data-src="<?= $image->getUrl() ?>" src="<?= $image->getUrl('200x') ?>" alt="<?= $color_name ?>" data-position="<?= $image_position ?>" data-color="<?= $color_name ?>" data-size="<?= $size ?>">
                ...
                <div class="row my-4 info-panel">
                    ...
                    <div class="col-lg-4 col-md-4 col-12 text-center">
                        <button class="btn btn-dark add-to-cart btn-block" data-id="<?= $product->id ?>"><?= Yii::t('app', 'Add to cart!') ?></button>
                    </div>
                </div>
                <?php if ($product->vase) : ?>
                <hr>
                ...
                <div class="vase dark-elements my-4">
                    ...
                    <div class="checkbox">
                        ...
                        <span class="mt-1 mx-1 d-block"><span class="vase-price"><?= $product->vase ?></span> sum</span>
                    </div>
                    <div>
